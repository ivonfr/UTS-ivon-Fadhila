				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<div class="table-responsive">
							<table class="table table-hover" id="example">
								...
								<?php foreach ($hero_list as $key) { ?>
									<tr>
										...
										<td><?php echo "<img src='http://localhost/codeigniter_UTS21/assets/uploads/$key->foto' height='75px' width='50px'>" ?></td>
										<td>
							...
							<a href="<?php echo site_url('hero/create/'.$this->uri->segment(3)) ?>" type="button" class="btn btn-warning">Tambah Hero</a>
